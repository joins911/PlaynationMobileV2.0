...
public class BundleBuilder {
	...
	//			cursor.getString(cursor.getColumnIndex(Keys.isMember)));
		...
		bundle.putString(Keys.GamesisSubscribed,
				cursor.getInt(cursor.getColumnIndex(Keys.GamesisSubscribed))
						+ "");
		bundle.putString(Keys.GamePostCount,
	...
	public static Bundle putPWallInBundle(Cursor cursor) {
		...
		bundle.putString(Keys.ItemType,
				cursor.getString(cursor.getColumnIndex(Keys.ItemType)));
		bundle.putString(Keys.PLAYERAVATAR,
				cursor.getString(cursor.getColumnIndex(Keys.PLAYERAVATAR)) + "");
		bundle.putString(Keys.WallLastActivityTime, cursor.getString(cursor
				.getColumnIndex(Keys.WallLastActivityTime)));
		bundle.putString(Keys.WallMessage,
				cursor.getString(cursor.getColumnIndex(Keys.WallMessage)));
		bundle.putString(Keys.WallOwnerType,
				cursor.getString(cursor.getColumnIndex(Keys.WallOwnerType)));
		bundle.putString(Keys.WallPostingTime,
				cursor.getString(cursor.getColumnIndex(Keys.WallPostingTime)));
		return bundle;
	}

	public static Bundle putPMsgInBundle(Cursor cursor) {
		Bundle bundle = new Bundle();
		bundle.putString(Keys.ID_MESSAGE,
				cursor.getInt(cursor.getColumnIndex(Keys.ID_MESSAGE)) + "");
		bundle.putString(
		...
		bundle.putString(Keys.MessageText,
				cursor.getString(cursor.getColumnIndex(Keys.MessageText)));
		bundle.putString(Keys.MessageTime,
				cursor.getString(cursor.getColumnIndex(Keys.MessageTime)));
		return bundle;
	}
	...
	public static Bundle putPlayerInBundle(Cursor cursor) {
		...
		bundle.putString(Keys.COUNTRY,
				cursor.getString(cursor.getColumnIndex(Keys.COUNTRY)));
		bundle.putString(Keys.PLAYERNICKNAME,
				cursor.getString(cursor.getColumnIndex(Keys.PLAYERNICKNAME)));
		bundle.putString(Keys.PLAYERAVATAR,
				cursor.getString(cursor.getColumnIndex(Keys.PLAYERAVATAR)));
		...
		bundle.putString(Keys.LastName,
				cursor.getString(cursor.getColumnIndex(Keys.LastName)));
		bundle.putString(Keys.Age,
				cursor.getString(cursor.getColumnIndex(Keys.Age)));
		bundle.putString(Keys.PLAYERNAME, firstName + "," + lastName);
	...
	public static Bundle putCompanyInBundle(Cursor cursor) {
		...
		bundle.putString(Keys.GameIsLiked,
				cursor.getString(cursor.getColumnIndex(Keys.GameIsLiked)));
		bundle.putString(Keys.CompanyEmployees,
				cursor.getString(cursor.getColumnIndex(Keys.CompanyEmployees)));
		bundle.putString(Keys.CompanyImageURL,
				cursor.getString(cursor.getColumnIndex(Keys.CompanyImageURL)));
		bundle.putString(Keys.CompanyAddress,
				cursor.getString(cursor.getColumnIndex(Keys.CompanyAddress)));
		bundle.putString(Keys.CompanyDesc,
				cursor.getString(cursor.getColumnIndex(Keys.CompanyDesc)));
		bundle.putString(Keys.CompanyFounded,
				cursor.getString(cursor.getColumnIndex(Keys.CompanyFounded)));
		bundle.putString(Keys.CompanyURL,
				cursor.getString(cursor.getColumnIndex(Keys.CompanyURL)));
		bundle.putString(Keys.CompanyCreatedTime, cursor.getString(cursor
				.getColumnIndex(Keys.CompanyCreatedTime)));
		bundle.putString(Keys.CompanyOwnership,
				cursor.getString(cursor.getColumnIndex(Keys.CompanyOwnership)));
		bundle.putString(Keys.CompanyType,
				cursor.getString(cursor.getColumnIndex(Keys.CompanyType)));
		bundle.putString(Keys.CompanyNewsCount,
				cursor.getString(cursor.getColumnIndex(Keys.CompanyNewsCount)));
		bundle.putString(Keys.CompanyEventCount,
				cursor.getString(cursor.getColumnIndex(Keys.CompanyEventCount)));
		bundle.putString(Keys.CompanyGameCount,
				cursor.getString(cursor.getColumnIndex(Keys.CompanyGameCount)));
		bundle.putString(Keys.CompanySocialRating, cursor.getString(cursor
	...
	public static Bundle putPEventInBundle(Cursor cursor) {
		...
		bundle.putString(Keys.EventID_COMPANY,
				cursor.getInt(cursor.getColumnIndex(Keys.EventID_COMPANY)) + "");
		bundle.putString(Keys.ID_GAME,
				cursor.getInt(cursor.getColumnIndex(Keys.ID_GAME)) + "");
		bundle.putString(Keys.ID_GROUP,
				cursor.getInt(cursor.getColumnIndex(Keys.ID_GROUP)) + "");
		bundle.putString(Keys.EventID_TEAM,
				cursor.getInt(cursor.getColumnIndex(Keys.EventID_TEAM)) + "");
		bundle.putString(Keys.EventIMAGEURL,
				cursor.getString(cursor.getColumnIndex(Keys.EventIMAGEURL)));
		bundle.putString(Keys.EventDescription,
				cursor.getString(cursor.getColumnIndex(Keys.EventDescription)));
		bundle.putString(Keys.EventDuration,
				cursor.getString(cursor.getColumnIndex(Keys.EventDuration)));
		bundle.putString(Keys.EventHeadline,
				cursor.getString(cursor.getColumnIndex(Keys.EventHeadline)));
		bundle.putString(Keys.EventTime,
				cursor.getString(cursor.getColumnIndex(Keys.EventTime)));
		bundle.putString(Keys.EventLocation,
				cursor.getString(cursor.getColumnIndex(Keys.EventLocation)));
		bundle.putString(Keys.EventInviteLevel,
				cursor.getString(cursor.getColumnIndex(Keys.EventInviteLevel)));
		bundle.putString(Keys.EventIsPublic,
				cursor.getInt(cursor.getColumnIndex(Keys.EventIsPublic)) + "");
		bundle.putString(Keys.EventType,
				cursor.getString(cursor.getColumnIndex(Keys.EventType)));
		bundle.putString(Keys.EventIsExpired,
				cursor.getInt(cursor.getColumnIndex(Keys.EventIsExpired)) + "");
		return bundle;
	}
}
